...
if __name__ == '__main__':
    ...
    for l_0 in L_0:
        ...
        # CSV出力
        pivoted_cg.to_csv(f"CG_D_wide_format_L_0={l_0}.csv", float_format="%.4f")
        print(f"\n結果を 'CG_D_wide_format_L_0={l_0}.csv' に保存しました。")
        ...
        pivoted_mvr.to_csv(f"MVR_D_wide_format_L_0={l_0}.csv", float_format="%.4f")
        print(f"結果を 'MVR_D_wide_format_L_0={l_0}.csv' に保存しました。")
