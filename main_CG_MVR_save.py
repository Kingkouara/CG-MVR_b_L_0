...
def generate_synthetic_data(N, M, L_0, b):
    ...
    for i in range(M):
        ...
        # ランダムにL_0人を選ぶ
        # ranking_length = np.random.randint(L_0 - 0.3*L_0, L_0 + 0.3*L_0)
        ranking_length = L_0
        candidates = np.random.choice(N, size=ranking_length, replace=False)  # ランダムにL_0人を選ぶ
...
if __name__ == '__main__':
    ...
    # ここを変える
    num_iterations = 3
    b_values = [0.9,0,91,0.92,0.93,0.94,0.95,0.96,0.97,0.98,0.99]
    # b_values = [0.7,1.0]
    # -------------------------
